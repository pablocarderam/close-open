...
var web20Txt = "¿Qué es la Web 2.0? \nPrimero que todo... ¿qué es Web 1.0?  El Internet, como toda tecnología, fue un espacio exclusivo durante sus primeras décadas de existencia. Requerías de un computador con conexión telefónica para poder leer las páginas web –que no eran más que eso, páginas estáticas– sino que requerías de conocimiento de la tecnología y habilidades de programación para poder construir contenido. Cormode & Krishnamurthy (2008) escriben: \"Los creadores de contenido en la Web 1.0 eran pocos, con la gran mayoría de los usuarios siendo simplemente consumidores de contenido\". La Web 2.0, en cambio, da un salto enorme hacia el usuario: a lo largo de la primera década del siglo XXI, el Internet se convirtió en un espacio cada vez más mundano dentro de la vida de más de tres mil millones de personas (internetlivestats.com, 2015). Además, estas personas son mucho más que lectores y usuarios pasivos: están –estamos– generando información a escalas que la humanidad nunca ha visto en su historia (O'Reilly, 2007).";
