...
var introTxts = [
    ...
    "¿No es increíble? Es parte de los milagros que permite la Web 2.0: el Internet interactivo y dinámico de hoy en día. (REF O'Reilly)",
    ...
    "Como si fuera poco, el Internet de hoy en día es mucho más que interacción y personalización. Internet es capaz de aprender sobre nosotros, saber qué cosas nos gustan y cuáles no, qué tipo de personas nos parecerían buenos amigos en Facebook, a quién seguir en Twitter y qué tipo de publicidad nos interesa más.",

    "Tim Berners Lee (REF) llama este fenómeno la \"Web semántica\": una Web legible para máquinas... pero en la que las máquinas terminan pensando por nosotros.",
...
var web20Txt = "web20Txt";
var web20WhatTxt = "... podría mencionar un google de ejemplos más. (Sí, un \"google\" era un número, pero por supuesto que ahora es un ente abstracto que toma nota de todo lo que hacemos y reduce nuestro rango de resultados con cada \"aprendizaje\". Si Wittgenstein viviera, diría: \"Los límites de mi Google son los límites de mi mundo.\" Jimmy Wales, fundador de Wikipedia, es más directo: \"Si no está en Google, es porque no existe\".";
var webSemTxt = "webSemTxt";
var webSemWhatTxt = "webSemWhatTxt";
